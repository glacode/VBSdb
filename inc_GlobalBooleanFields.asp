...
'***********************************************
'***********************************************
sub vbsDbSetDictionaryGlobalBooleanFields( byRef objVbsDb )
'***********************************************
'***********************************************
  vbsDbSetDictionaryObjectFromList "GlobalBooleanFields" , objVbsDb
end sub

'***********************************************
'***********************************************
function funBolGlobalBooleanField( strFieldName , objVbsDb )
'***********************************************
'***********************************************
  'funBolSqlFieldIsBoolean = ( objVbsDb( "SqlRecordSet" ).fields( strFieldName ).type = vbsDbAdBoolean )
  if isObject( objVbsDb( "DictionaryGlobalBooleanFields" ) ) then
			funBolGlobalBooleanField = _
				( objVbsDb( "DictionaryGlobalBooleanFields" ).exists( strFieldName ) )
		else
			funBolGlobalBooleanField = false
		end if
end function
...
'***********************************************
  'funBolSqlFieldIsBoolean = ( objVbsDb( "SqlRecordSet" ).fields( strFieldName ).type = vbsDbAdBoolean )
  if isObject( objVbsDb( "DictionaryGlobalBooleanFields" ) ) then
			funBolSqlFieldIsBoolean = _
				( ( objVbsDb( "DictionaryGlobalBooleanFields" ).exists( strFieldName ) ) or _
					( funVarSqlRecordSetFieldType( strFieldName , objVbsDb ) = vbsDbAdBoolean ) )
		else
			funBolSqlFieldIsBoolean = _
				( funVarSqlRecordSetFieldType( strFieldName , objVbsDb ) = vbsDbAdBoolean )
		end if
...
'***********************************************
  if VbsDbGetScreenType( objVbsDb ) = "Search" then
    ...
    funBolInputFieldIsBoolean = _
				( funVarSqlRecordSetFieldType( strFieldName , objVbsDb ) = vbsDbAdBoolean )
  else
    ' current screen is an edit screen
    funBolInputFieldIsBoolean =	funBolAdoxColumnIsBoolean( strFieldName , objVbsDb )
  end if
  if isObject( objVbsDb( "DictionaryGlobalBooleanFields" ) ) then
		funBolInputFieldIsBoolean = funBolInputFieldIsBoolean or _
			objVbsDb( "DictionaryGlobalBooleanFields" ).exists( strFieldName )
	end if
end function
